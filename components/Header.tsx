    ...
    <>
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm z-50 border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
          <Link
            href="/"
            className="flex items-center gap-2.5 text-amber-900 hover:text-amber-700 transition-colors"
          ...
          <div className="hidden md:flex gap-6 items-center">
            <Link href="/a-propos" className="text-stone-600 hover:text-amber-900 transition-colors font-medium text-sm">
              A propos
            </Link>
            <Link href="/blog" className="text-stone-600 hover:text-amber-900 transition-colors font-medium text-sm">
              Blog
            </Link>
            <Link href="/destinations" className="text-stone-600 hover:text-amber-900 transition-colors font-medium text-sm">
              Destinations
            </Link>
            <Link href="/contact" className="text-stone-600 hover:text-amber-900 transition-colors font-medium text-sm">
              Contact
            </Link>
            <Link href={accountHref} className="text-stone-600 hover:text-amber-900 transition-colors font-medium text-sm">
              {accountLabel}
            </Link>
            <Link
              href="/travel-planning-form"
              className="px-5 py-2 bg-amber-900 text-white rounded-full hover:bg-amber-800 transition-colors text-sm font-medium shadow-sm"
            >
              Planifier
            </Link>
          </div>
        ...
        >
          <div className="px-4 py-6 flex flex-col gap-1">
            ...
            <Link
              ...
              className="flex items-center gap-3 px-4 py-3 text-stone-700 hover:text-amber-900 hover:bg-amber-50 rounded-xl transition-colors font-medium"
            >
              <span className="w-8 h-8 rounded-full bg-eucalyptus/10 border border-eucalyptus/30 text-eucalyptus flex items-center justify-center flex-shrink-0">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
