        ...
        <div style={{ flex: 1, overflow: 'auto', padding: '1.5rem' }}>
          ...
          {tab === 'cloud' && (
            <div style={{ maxWidth: 520, margin: '0 auto', textAlign: 'center', padding: '2rem' }}>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1a1a1a', marginBottom: '.75rem' }}>Google Photos</h3>
              <p style={{ color: '#666', marginBottom: '1.5rem', fontSize: '.9rem', lineHeight: 1.5 }}>
                Tu choisis les photos dans ta photothèque Google, elles arrivent ici avec leur date.
                Depuis mars 2025, Google n&apos;autorise plus une application à parcourir la photothèque :
                c&apos;est toi qui sélectionnes, dans l&apos;interface Google Photos.
              </p>
              <a
                href="/panel-manager/photos"
                style={{ display: 'inline-block', padding: '.8rem 1.5rem', background: '#2D8B7A', color: 'white', borderRadius: '9999px', fontWeight: 600, fontSize: '.9rem', textDecoration: 'none' }}
              >
                Choisir des photos dans Google Photos
              </a>
            </div>
          )}
        </div>
