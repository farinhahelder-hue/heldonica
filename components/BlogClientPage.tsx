...
export default function BlogClientPage({ posts: rawPosts }: Props) {
  ...
  // ⚡ Bolt Optimization: Debounce the search query to prevent heavy list filtering
  // from blocking the main UI thread while typing.
  // Impact: Improves input perceived responsiveness and prevents UI stuttering
  // when rendering long lists of posts.
