...
export default function BlogClientPage({ posts: rawPosts }: Props) {
  ...
  // Using useDeferredValue for the search query to decouple the input rendering
  // from the heavy list filtering logic. This ensures the main UI thread isn't blocked
  // when the user types quickly into the search box, keeping typing responsive.
