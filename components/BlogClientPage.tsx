...
export default function BlogClientPage({ posts: rawPosts }: Props) {
  ...
  // ⚡ Bolt Optimization: useDeferredValue prevents the heavy list filtering from blocking the main thread during typing.
  // Impact: Keeps the search input highly responsive (target <50ms keystroke latency) even when the blog post list grows large.
