...
const GROUPS: GroupDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'pillar_labels', label: 'Étiquettes pages piliers (JSON)', type: 'textarea', placeholder: '{"cta":"Demander mon voyage sur mesure →","faqHeading":"Questions fréquentes"}' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'footer_destinations_json', label: 'Destinations footer (JSON)', type: 'textarea', placeholder: '[{"label":"Madère","href":"/destinations/madere"},{"label":"Roumanie","href":"/destinations/roumanie"}]' },
      { key: 'footer_nav_json',           label: 'Navigation footer (JSON)',  type: 'textarea', placeholder: '[{"label":"Destinations","href":"/destinations"},{"label":"Blog","href":"/blog"}]' },
      { key: 'footer_guides_json',        label: 'Guides footer (JSON)',     type: 'textarea', placeholder: '[{"label":"Guide Madère","href":"/guides/top-10-pepites-madere"}]' },
    ],
  },
  {
    id: 'navigation',
    ...
    fields: [
      ...
      { key: 'breadcrumb_blog',                label: 'Blog (fil d\'Ariane)',        type: 'text', placeholder: 'Blog' },
      { key: 'breadcrumb_destinations',         label: 'Destinations (fil d\'Ariane)',type: 'text', placeholder: 'Destinations' },
      { key: 'breadcrumb_a_propos',             label: 'À propos (fil d\'Ariane)',   type: 'text', placeholder: 'À propos' },
      { key: 'breadcrumb_travel_planning',      label: 'Travel Planning',            type: 'text', placeholder: 'Travel Planning' },
      { key: 'breadcrumb_travel_planning_form', label: 'Planifier',                  type: 'text', placeholder: 'Planifier' },
      { key: 'breadcrumb_contact',              label: 'Contact',                    type: 'text', placeholder: 'Contact' },
      { key: 'breadcrumb_mentions_legales',     label: 'Mentions légales',           type: 'text', placeholder: 'Mentions légales' },
    ],
  },
  {
    id: 'newsletter',
