...
export default function DestinationForm({ destinationId, onSave, onCancel }: DestinationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = destinationId ? `/api/destinations/${destinationId}` : '/api/destinations';
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h3 className="text-xl font-bold mb-6">{destinationId ? 'Edit Destination' : 'New Destination'}</h3>
