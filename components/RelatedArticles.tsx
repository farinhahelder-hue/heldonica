                ...
                <div className="relative h-48 overflow-hidden">
                  {article.featured_image ? (
                    ...
                    <div className={`absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br ${
                      article.category === 'Découvertes Locales' ? 'from-mahogany to-eucalyptus' : 'from-eucalyptus to-teal'
                    }`}>
                      <svg aria-hidden="true" className="w-8 h-8 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
