            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                {post.tags?.slice(0, 2).map((t) => (
                  <span key={t} className="bg-white/20 text-white text-xs px-2.5 py-1 rounded-full backdrop-blur-sm">{t}</span>
                ))}
              </div>
        ...
        {related.length > 0 && (
          <section className="bg-stone-50 py-16">
            <div className="max-w-6xl mx-auto px-4">
              <h2 className="text-2xl font-bold text-gray-900 mb-8">Dans la même catégorie</h2>
                  ...
                  <Link key={p.slug} href={`/blog/${p.slug}`} className="group">
                    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      {p.image_url ? (
                        ...
                        <div className="w-full h-44 bg-amber-50 flex items-center justify-center text-4xl opacity-40">✈️</div>
                      )}
                      <div className="p-4">
