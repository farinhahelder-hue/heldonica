...
export function generateMetadata(): Metadata {
  return {
    title: "Costa Smeralda en couple : slow travel & pépites cachées | Heldonica",
    description: "Le nord.millionnaires, plages incredible.",
    openGraph: {
      type: "website",
    ...
    alternates: {
      canonical: "https://heldonica.fr/destinations/sardaigne/costa-smeralda"
    }
  };
}
