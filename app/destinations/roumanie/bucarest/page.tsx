...
export default function BucarestPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"TouristDestination","name":"Bucarest","description":"Guide Bucarest: Macro, culture, vie nocturne.","url":"https://heldonica.fr/destinations/roumanie/bucarest","touristType":{"@type":"Audience","audienceType":"couple"},"geo":{"@type":"GeoCoordinates","latitude":44.4361414,"longitude":26.102684}}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Accueil","item":"https://heldonica.fr"},{"@type":"ListItem","position":2,"name":"Destinations","item":"https://heldonica.fr/destinations"},{"@type":"ListItem","position":3,"name":"Roumanie","item":"https://heldonica.fr/destinations/roumanie"},{"@type":"ListItem","position":4,"name":"Bucarest","item":"https://heldonica.fr/destinations/roumanie/bucarest"}]}) }} />
      <Header />
