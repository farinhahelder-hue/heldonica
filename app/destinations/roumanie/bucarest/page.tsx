...
const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.heldonica.fr/destinations/roumanie/bucarest"
  }
}

export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-roumanie-bucarest', metadata)
}
...
export default async function BucarestPage() {
  const zones = await getPageZones('destinations-roumanie-bucarest')
  return (
    <InlineEditProvider page="destinations-roumanie-bucarest" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-roumanie-bucarest"
        name="Bucarest"
        parentName="Roumanie"
        parentSlug="roumanie"
