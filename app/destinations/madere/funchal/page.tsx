...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-madere-funchal', metadata)
}
...
export default async function FunchaletenvironsPage() {
  const zones = await getPageZones('destinations-madere-funchal')
  return (
    <InlineEditProvider page="destinations-madere-funchal" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-madere-funchal"
