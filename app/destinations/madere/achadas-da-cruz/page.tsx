...
export function generateMetadata(): Metadata {
  return {
    title: "Achadas da Cruz en couple : slow travel & pépites cachées | Heldonica",
    description: "Le funiculaire. 1000m de chute. Vertige.",
    openGraph: {
      type: "website",
    ...
    alternates: {
      canonical: "https://heldonica.fr/destinations/madere/achadas-da-cruz"
    }
  };
}
