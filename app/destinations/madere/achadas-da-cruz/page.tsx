...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-madere-achadas-da-cruz', metadata)
}
...
export default async function AchadasdaCruzPage() {
  const zones = await getPageZones('destinations-madere-achadas-da-cruz')
  return (
    <InlineEditProvider page="destinations-madere-achadas-da-cruz" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-madere-achadas-da-cruz"
