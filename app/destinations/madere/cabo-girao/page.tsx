...
export function generateMetadata(): Metadata {
  return {
    title: "Cabo Girao en couple : slow travel & pépites cachées | Heldonica",
    description: "La plus haute falaise d Europe. 580m a pic sur l ocean.",
    openGraph: {
      type: "website",
    ...
    alternates: {
      canonical: "https://heldonica.fr/destinations/madere/cabo-girao"
    }
  };
}
