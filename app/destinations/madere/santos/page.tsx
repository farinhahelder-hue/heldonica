...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-madere-santos', metadata)
}
...
export default async function SantosPage() {
  const zones = await getPageZones('destinations-madere-santos')
  return (
    <InlineEditProvider page="destinations-madere-santos" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-madere-santos"
        name="Santos"
        parentName="Madère"
        parentSlug="madere"
