...
export function generateMetadata(): Metadata {
  return {
    title: "Taormine en couple : slow travel & pépites cachées | Heldonica",
    description: "Est. Theatre grec, vue mer.",
    openGraph: {
      type: "website",
    ...
    alternates: {
      canonical: "https://heldonica.fr/destinations/sicile/taormine"
    }
  };
}
