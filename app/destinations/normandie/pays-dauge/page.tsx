...
export default async function PaysdAugePage() {
  const zones = await getPageZones('destinations-normandie-pays-dauge')
  return (
    <InlineEditProvider page="destinations-normandie-pays-dauge" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-normandie-pays-dauge"
        name="Pays d Auge"
