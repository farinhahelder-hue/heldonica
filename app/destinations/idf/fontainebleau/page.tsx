...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-idf-fontainebleau', metadata)
}
...
export default async function FontainebleauPage() {
  const zones = await getPageZones('destinations-idf-fontainebleau')
  return (
    <InlineEditProvider page="destinations-idf-fontainebleau" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-idf-fontainebleau"
        name="Fontainebleau"
        parentName="IdF"
        parentSlug="idf"
