      ...
      <main className="min-h-screen bg-stone-50">
        <section className="bg-gradient-to-b from-stone-900 to-stone-800 py-20">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-stone-300 max-w-2xl">Paris, chateaux, nature. La region.</p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <section className="mb-12">
            ...
            <p className="text-lg text-stone-700 leading-relaxed mt-4">
              Les Parcs, les chateaux, les grands espaces verts.
              <strong>Tout est a cote.</strong>
            </p>
          </section>
          ...
          <section className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg border">
              ...
              <ul className="text-stone-600 text-sm space-y-1">
                ...
                <li>Septembre - Octobre: Parfait</li>
                <li>Toute l annee: Paris</li>
              </ul>
            </div>
            <div className="bg-white p-6 rounded-lg border">
