...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata('destinations-idf-paris', metadata)
}
...
export default async function ParisPage() {
  const zones = await getPageZones('destinations-idf-paris')
  return (
    <InlineEditProvider page="destinations-idf-paris" initialZones={zones}>
      <Header />
      <SubDestinationTemplate
        page="destinations-idf-paris"
        name="Paris"
        parentName="IdF"
        parentSlug="idf"
