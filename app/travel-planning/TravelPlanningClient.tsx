...
export default function TravelPlanningClient() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormStatus('error')
      setFormError(err instanceof Error ? err.message : 'Une erreur est survenue. Écris-nous à contact@heldonica.fr')
    }
  }
          ...
          <div className="container max-w-5xl">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                { zone: 'promise_3', emoji: '📞', fallbackTitle: 'Suivi humain', fallbackText: 'Un mail, un WhatsApp — on répond, on ajuste, on reste là du premier échange jusqu\'à ton retour.' },
              ].map((p) => (
