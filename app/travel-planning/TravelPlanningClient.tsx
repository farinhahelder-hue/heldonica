      ...
      <main>
        ...
        <section className="py-20 md:py-24 bg-stone-950 text-white">
          <div className="max-w-5xl mx-auto px-6 md:px-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { quote: 'On n'a jamais eu la sensation d'exécuter un plan. On avançait, et tout semblait tomber au bon moment.', name: 'Marie & Théo', dest: 'Madère · 10 jours' },
                { quote: 'Le carnet était précis sans être rigide. On sentait qu'il avait été pensé par des gens qui avaient vraiment marché là-bas.', name: 'Sophie & Lucas', dest: 'Colombie · 14 jours' },
                { quote: 'Même avec nos contraintes enfants + budget + fatigue, on a eu un voyage qui nous ressemblait. Et ça, c'est rare.', name: 'Camille & Romain', dest: 'Sicile · 8 jours' },
              ].map((t, i) => (
        ...
        <section className="py-24 md:py-32 bg-amber-900 text-white relative overflow-hidden">
          <div
            ...
            style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=1200&q=60)', backgroundSize: 'cover', backgroundPosition: 'center' }}
          />
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: { '@type': 'Answer', text: "Un travel planning sur mesure, c'est la conception complète de ton itinéraire de voyage selon tes envies, ton rythme et tes valeurs. Heldonica crée des voyages écoresponsables hors des sentiers battus, avec des adresses authentiques testées sur le terrain." },
              },
              {
                '@type': 'Question',
                name: 'Combien coûte un travel planning sur mesure ?',
                acceptedAnswer: { '@type': 'Answer', text: 'Le tarif varie selon la durée et la complexité du voyage. Contacte-nous via le formulaire pour recevoir un devis personnalisé.' },
              },
              {
                '@type': 'Question',
                name: 'Pour quels types de voyages proposez-vous du travel planning ?',
                acceptedAnswer: { '@type': 'Answer', text: "On conçoit des voyages slow travel écoresponsables en Europe et à l'international : road trips, city breaks lents, immersions locales, destinations hors des sentiers battus comme Madère, la Roumanie ou la Sicile." },
              },
            ],
          }),
        }}
