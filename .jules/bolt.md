...
## 2024-11-20 - Batch independent queries in Next.js pages
**Learning:** Sequential await calls in Next.js Server Components and ISR pages delay Time To First Byte (TTFB). Batching them with Promise.all fetches data concurrently, improving load times.
**Action:** Always identify independent data fetching queries and group them into a Promise.all batch.
