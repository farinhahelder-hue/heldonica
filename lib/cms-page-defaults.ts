...
export const PAGE_DEFAULTS: Record<string, string> = {
  ...
  'home__blog_title': 'Du terrain, pour vous',
  'home__blog_subtitle': 'Carnets de route et découvertes authentiques',
  'home__newsletter_title': 'Recevez nos dernières pépites',
  'home__newsletter_text': 'Carnets de route, bons plans voyage, destinations secrètes.',
